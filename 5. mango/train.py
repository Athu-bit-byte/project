...
DATASET_PATH = r"C:\Users\allen\Downloads\mango\train"
MODEL_SAVE_PATH = r"C:\Users\allen\Downloads\mango\model_mango_disease.keras"
...
def train():
    ...
    plt.title("Accuracy")
    plt.savefig(r"C:\Users\allen\Downloads\mango\accuracy.png")
    plt.clf()
    ...
    plt.legend(["Train", "Val"])
    plt.title("Loss")
    plt.savefig(r"C:\Users\allen\Downloads\mango\loss.png")
